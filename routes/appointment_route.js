...
const upload = require("../middlewares/completeImagesMulter")
...
router.put("/completeAppointment", upload.array('images') ,controller.completeAppointment);
...
router.get("/getAppointmentById", controller.getAppointmentById);
